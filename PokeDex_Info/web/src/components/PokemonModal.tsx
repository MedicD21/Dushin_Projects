...
export default function PokemonModal({
  ...
  return (
    <>
      ...
      />
      <div
        className="fixed top-0 left-0 right-0 z-50 flex items-start justify-center p-4 overflow-y-auto pointer-events-none"
        onClick={onClose}
        style={{ maxHeight: "100vh" }}
      >
        <div
          className="bg-gray-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border-2 border-yellow-500 pointer-events-auto mt-8"
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="text-white">
                        {pokemon.breeding_info.egg_groups.join(", ") ||
                          "Unknown"}
                      </p>
                    </div>
                    <div>
