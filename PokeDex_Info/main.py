...
class PokemonDataOrchestrator:
    ...
    def show_menu(self):
        ...
        print("2. Run basic Pokemon scraper")
        print("3. Run comprehensive Pokemon scraper")
        print("4. Run game dex scraper")
        print("5. Run abilities scraper")
        print("6. Run all scrapers (complete collection)")
        print("7. Data management tools")
        print("8. Exit")
        print()
